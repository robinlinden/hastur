...
genrule(
    ...
    cmd = r"""
        ...
        $(location pkgdata) --bldopt $(location pkgdata_inc) --entrypoint icudt77 --sourcedir $(RULEDIR) --destdir $(RULEDIR) --name icudt77l --mode static $${srcs[0]}
    """,
    tools = [
        ":icupkg",
        ":pkgdata",
...
genrule(
    ...
    cmd = r"""
        ...
        $(location pkgdata) --entrypoint icudt77 --sourcedir $(RULEDIR) --destdir $(RULEDIR) --name icudt77l --mode static $${srcs[0]}
    """,
    tools = [
        ":icupkg",
        ":pkgdata",
...
cc_import(
    ...
    static_library = select({
        "@platforms//os:windows": ":sicudt77l.lib",
        "//conditions:default": ":libicudt77l.a",
    }),
    visibility = ["//visibility:public"],
    alwayslink = True,
)
