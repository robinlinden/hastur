...
public:
    ...
    [[nodiscard]] virtual QuirksMode quirks_mode() const = 0;
    [[nodiscard]] virtual bool scripting() const = 0;
    ...
    [[nodiscard]] virtual std::string_view current_node_name() const = 0;
    ...
    [[nodiscard]] virtual bool frameset_ok() const = 0;
    ...
    [[nodiscard]] virtual bool head_element_set() const = 0;
    [[nodiscard]] virtual std::optional<std::string_view> fragment_parsing_context() const = 0;
    ...
    [[nodiscard]] virtual std::vector<std::string_view> names_of_open_elements() const = 0;

    [[nodiscard]] virtual InsertionMode current_insertion_mode() const = 0;
};
